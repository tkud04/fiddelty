...
<form method="post" action="<?php echo e(url('contact')); ?>" enctype="multipart/form-data" class="EPiServerForms ValidationSuccess" id="contact-form">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\bkupp\lokl\repo\fidellty\resources\views/contact.blade.php ENDPATH**/ ?>